...
- (void)viewDidLoad
{
	...
	[toggleButton setImage:[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerAlbumInfo" ofType:@"png"]] forState:UIControlStateNormal];
	...
	// reflectionView.image = [self reflectedImage:artworkView withHeight:artworkView.bounds.size.height];
	...
	buttonBackground.image = [[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerBarBackground" ofType:@"png"]] stretchableImageWithLeftCapWidth:0 topCapHeight:0];
	[self.view addSubview:buttonBackground];
		
	self.playButton = [[UIButton alloc] initWithFrame:CGRectMake(144, self.view.bounds.size.height - 90, 40, 40)];
	UIImage *playButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"play" ofType:@"png"]];
	playButtonImage = [playButtonImage imageTintedWithColor:[UIColor whiteColor]];
	...
	UIImage *pauseButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"pause" ofType:@"png"]];
	pauseButtonImage = [pauseButtonImage imageTintedWithColor:[UIColor whiteColor]];
	...
	UIImage *nextButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"end" ofType:@"png"]];
	nextButtonImage = [nextButtonImage imageTintedWithColor:[UIColor whiteColor]];
	...
	UIImage *previousButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"skip_to_start" ofType:@"png"]];
	previousButtonImage = [previousButtonImage imageTintedWithColor:[UIColor whiteColor]];
	...
	[volumeSlider setThumbImage:[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerVolumeKnob" ofType:@"png"]]
														forState:UIControlStateNormal];
	[volumeSlider setMinimumTrackImage:[[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerScrubberLeft" ofType:@"png"]] stretchableImageWithLeftCapWidth:5 topCapHeight:3]
					   forState:UIControlStateNormal];
	[volumeSlider setMaximumTrackImage:[[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerScrubberRight" ofType:@"png"]] stretchableImageWithLeftCapWidth:5 topCapHeight:3]
							  forState:UIControlStateNormal];
...
- (void)showSongFiles
{
	...
	if ([songTableView superview])
		[self.toggleButton setImage:[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerAlbumInfo" ofType:@"png"]] forState:UIControlStateNormal];
	else
	...
	{
		[self.artworkView setImage:[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerTableBackground" ofType:@"png"]] forState:UIControlStateNormal];
...
{	
	...
	{		
		...
		[progressSlider setThumbImage:[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerScrubberKnob" ofType:@"png"]]
						   forState:UIControlStateNormal];
		[progressSlider setMinimumTrackImage:[[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerScrubberLeft" ofType:@"png"]] stretchableImageWithLeftCapWidth:5 topCapHeight:3]
								  forState:UIControlStateNormal];
		[progressSlider setMaximumTrackImage:[[UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"AudioPlayerScrubberRight" ofType:@"png"]] stretchableImageWithLeftCapWidth:5 topCapHeight:3]
								  forState:UIControlStateNormal];
		...
		UIImage *repeatButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"repeat" ofType:@"png"]];
		repeatButtonImage = [repeatButtonImage imageTintedWithColor:[UIColor whiteColor]];
		[repeatButton setImage:repeatButtonImage forState:UIControlStateNormal];
		...
		UIImage *shuffleButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"shuffle" ofType:@"png"]];
		shuffleButtonImage = [shuffleButtonImage imageTintedWithColor:[UIColor whiteColor]];

		[shuffleButton setImage:shuffleButtonImage forState:UIControlStateNormal];
...
- (void)toggleShuffle
{
	...
	else
	{
		shuffle = YES;
		UIImage *shuffleButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"shuffle" ofType:@"png"]];
		shuffleButtonImage = [shuffleButtonImage imageTintedWithColor:[UIColor blueColor]];
...
- (void)toggleRepeat
{
	...
	{
		UIImage *repeatButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"repeat" ofType:@"png"]];
		repeatButtonImage = [repeatButtonImage imageTintedWithColor:[UIColor brownColor]];
		[repeatButton setImage:repeatButtonImage forState:UIControlStateNormal];
		repeatOne = YES;
		repeatAll = NO;
	}
	...
	{
		UIImage *repeatButtonImage = [UIImage imageWithContentsOfFile:[getBundle() pathForResource:@"repeat" ofType:@"png"]];
		repeatButtonImage = [repeatButtonImage imageTintedWithColor:[UIColor blueColor]];
		[repeatButton setImage:repeatButtonImage forState:UIControlStateNormal];
		repeatOne = NO;
		repeatAll = YES;
	}
