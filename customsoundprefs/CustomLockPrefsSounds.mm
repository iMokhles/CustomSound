...
@interface CustomSoundPrefsSoundsListController ()
...
@implementation CustomSoundPrefsSoundsListController
...
// Do any additional setup after loading the view, typically from a nib.
   ...
   if ([language isEqualToString:@"ar"]) {
        self.navigationItem.title = @"قائمة الصوتيات";
    } else {
        self.navigationItem.title = @"Sounds List";
    }
    //Add a edit button
    ...
    NSString *soundsDir = [@"/var/mobile/Library/CustomSound/" stringByAppendingPathComponent:@"/Sounds/"];
...
-(void)applySelection {
    ...
    ASMyToneViewControllerLS *custonSoundsTable = [[ASMyToneViewControllerLS alloc] init];
    ...
    // for (NSString *song in self.arrayCells)
    // {
    //     MDAudioFile *audioFile = [[MDAudioFile alloc] initWithPath:[NSURL fileURLWithPath:[NSString stringWithFormat:@"/var/mobile/Library/CustomSound/Sounds/%@.caf", song]]];
    //     [songs addObject:audioFile];
    // }
